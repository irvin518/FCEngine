...
{
    TString strFileName = _T("Language.bin");
    TString FilePath = CResourcePathManager::GetInstance()->GetFullPathForFilename(strFileName);
...
void CEditLanguageDialog::LanguageSwitch()
{
    ...
    m_pSrchText->SetLabel(pLanguageManager->GetText(eL_SearchEnum));
