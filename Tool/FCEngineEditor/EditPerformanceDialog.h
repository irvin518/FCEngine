#ifndef FCENGINEEDITOR_EditPerformanceDialog_H__INCLUDE
#define FCENGINEEDITOR_EditPerformanceDialog_H__INCLUDE
#include <wx/dialog.h>
...
class EditPerformanceDialog:public CEditDialogBase
{
    typedef CEditDialogBase super;
public:
    EditPerformanceDialog(wxWindow *parent, wxWindowID id, const wxString &title
        , const wxPoint &pos = wxDefaultPosition
        , const wxSize &size = wxDefaultSize
        , long style =  wxRESIZE_BORDER | wxMINIMIZE_BOX | wxMAXIMIZE_BOX | wxCLOSE_BOX | wxCAPTION
        , const wxString &name = wxDialogNameStr);

    virtual ~EditPerformanceDialog();
