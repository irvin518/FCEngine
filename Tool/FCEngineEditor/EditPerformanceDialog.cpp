...
void EditPerformanceDialog::LanguageSwitch()
{
    ...
    m_pPeakValueLabel->SetLabel(pLanguageManager->GetText(eL_PeakTime) + wxT(":"));
    ...
    m_pSubItemInfoGrid->SetColLabelValue( 2, pLanguageManager->GetText(eL_PeakTime) );
...
void EditPerformanceDialog::SetGridRowsCount( wxGrid* pGrid, size_t count )
{
