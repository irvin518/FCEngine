...
CBatchRenderGroup *CFontManager::GetRenderGroup()
{
    if(!m_pRenderGroup)
    {
        m_pRenderGroup = dynamic_cast<CBatchRenderGroup *>(
            CRenderGroupManager::GetInstance()->GetRenderGroup(CRenderGroupManager::LAYER_FONT));
