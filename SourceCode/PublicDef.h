...
template< class T> bool ComparePtrVector( const std::vector<T*>& v1, const std::vector<T*>& v2 )
{
    bool bReturn = true;
    if( v1 != v2 )
    {
...
#define FC_HOST_IS_BIG_ENDIAN (bool)(*(unsigned short *)"\0\xff" < 0x100) 
#define FC_SWAP32(i)  ((i & 0x000000ff) << 24 | (i & 0x0000ff00) << 8 | (i & 0x00ff0000) >> 8 | (i & 0xff000000) >> 24)
#define FC_SWAP16(i)  ((i & 0x00ff) << 8 | (i &0xff00) >> 8)   
#define FC_SWAP_INT32_LITTLE_TO_HOST(i) ((FC_HOST_IS_BIG_ENDIAN == true)? FC_SWAP32(i) : (i) )
#define FC_SWAP_INT16_LITTLE_TO_HOST(i) ((FC_HOST_IS_BIG_ENDIAN == true)? FC_SWAP16(i) : (i) )
#define FC_SWAP_INT32_BIG_TO_HOST(i)    ((FC_HOST_IS_BIG_ENDIAN == true)? (i) : FC_SWAP32(i) )
#define FC_SWAP_INT16_BIG_TO_HOST(i)    ((FC_HOST_IS_BIG_ENDIAN == true)? (i):  FC_SWAP16(i) )
