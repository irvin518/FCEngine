...
void CMaterial::Use()
{
    FC_PERFORMDETECT_START(ePNT_MaterialUse);
    ...
    FC_PERFORMDETECT_STOP(ePNT_MaterialUse);
}
...
{
    FC_PERFORMDETECT_START(ePNT_MaterialCompare);
    bool bEqual = false;
    ...
    FC_PERFORMDETECT_STOP(ePNT_MaterialCompare);
    return bEqual;
}
